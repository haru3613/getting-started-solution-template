...
Follow instructions first: 
  ...
  1. Now, on *Device* tab in navigator, select one device. In *Channels* menu choose your resource(s) to have control on it. You can set a specific setting for your channel.
